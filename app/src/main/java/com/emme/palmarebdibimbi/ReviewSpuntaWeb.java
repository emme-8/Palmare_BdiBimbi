...
public class ReviewSpuntaWeb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review_spunta_web);
    ...
    private void caricaDaRoom(){
        try {
            ...
            ReviewSpuntaWeb.DelDisc delDisc = new ReviewSpuntaWeb.DelDisc();
            delDisc.execute();
            if(nDiff > 0){
                ReviewSpuntaWeb.Disc disc = new ReviewSpuntaWeb.Disc();
                disc.execute();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void setRows(){
        AdapterReviewSpuntaWeb whatever = new AdapterReviewSpuntaWeb(this, codArt, desc, qtaDoc, qtaSpunta, alias, nDoc, fileName, tipo, timeSp, idDoc, tipoDoc, utenteSpunta, connection, idSpuntaDocRoom);
