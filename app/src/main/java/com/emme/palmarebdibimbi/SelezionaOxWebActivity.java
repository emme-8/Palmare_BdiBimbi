...
public class SelezionaOxWebActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seleziona_ox_web);
        ...
        if(isRemoto){
            SelezionaOxWebActivity.FindBF cerca = new SelezionaOxWebActivity.FindBF();
            cerca.execute("");
        }else{
            whereMag = " and Magazzino.nome = '"+nomeMag+"' ";
            SelezionaOxWebActivity.FindBFOFF cerca = new SelezionaOxWebActivity.FindBFOFF();
            cerca.execute("");
        }
    ...
    private void noConnection(String title,String message, final boolean error){
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(SelezionaOxWebActivity.this)
                .setTitle(title)
                .setMessage(message)
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
                        if(error) {
                            Intent intent = new Intent(SelezionaOxWebActivity.this, MainActivity.class);
    ...
    public void setRows(){
        AdapterSelOxWeb whatever = new AdapterSelOxWeb(this, id, ndoc, forn, data, tipoRiga, ubic, listino, mag, tipo, spuntaOrPresa, magazzino, listinoRif, magRif, serie, segnaC, utente, isRemoto, ipNeg);
