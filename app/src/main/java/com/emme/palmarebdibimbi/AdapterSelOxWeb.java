...
public class AdapterSelOxWeb extends ArrayAdapter implements CompoundButton.OnCheckedChangeListener{
    ...
    public AdapterSelOxWeb(Activity context, ArrayList<String> idArrayParam, ArrayList<String> ndocArrayParam, ArrayList<String> fornArrayParam, ArrayList<String> dataArrayParam,
        ...
        super(context,R.layout.adapter_ox_web , idArrayParam);
        this.tipo = tipo;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView=inflater.inflate(R.layout.adapter_ox_web, null,true);
            ...
            public void onClick(View v) {
                ...
                for(int i = 0; i<id.size(); i++){
                    ...
                    if(spuntaOrPresa==1){
                        ...
                        Intent openDoc = new Intent(context, ShowDocWebActivity.class);
